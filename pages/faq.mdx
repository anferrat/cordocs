...
If you have data in spreadsheet format that you'd like to import into the app, first create a blank survey and then utilize the "Import from spreadsheet" feature to generate a list of test points, pipelines, or rectifiers with your data.
...
You must purchase a multimeter from a third party and then connect it to the app. Multimiters also have their own apps that provides more in-depth access to all thier features.

**Is Corpad free to use?**

Yes, you can collect readings, perform calculations, and manage surveys on your phone for free. Some features, such as connecting a Bluetooth multimeter, capturing images, and viewing imported geodata files, are available for users with subscription.
