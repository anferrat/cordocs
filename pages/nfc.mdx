...
The only limitation is the capacity of the label. QR codes have slightly larger capacity, however both NFC and QR code labels are sufficient to store information of complex test points with multiple leads, or rectifiers.
