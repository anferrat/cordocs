...
To export a survey file, navigate to the survey list view (exit the opened survey if necessary), and tap on the triple-dot button next to the survey file name. In the context menu, select "Share file" and choose the application with which you'd like to share the file.
