...
**Time syncronization mode** - indicates how time should be syncronized on your phone.
...
Another method is NTP (Network Time Protocol). It gathers time data from dedicated time servers, it is fast, but requires access to the internet.
