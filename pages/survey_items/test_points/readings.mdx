...
This reading describes a test lead attached to the pipe. You can specify the pipeline it belongs to, along with properties such as wire gauge, color, and potential readings. (see [Potentials](/potentials.mdx))
